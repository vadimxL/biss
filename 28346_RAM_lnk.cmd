...
SECTIONS
{
   ...
   */
   ...
   AX0_PM_I_DP5         : > RAML3,          PAGE = 1
   AX0_PM_I_DP6         : > RAML3,          PAGE = 1
//   AX0_PM_I_DP7         : > RAML3,          PAGE = 1
   AX0_PM_I_DP8         : > RAML3,          PAGE = 1
   AX0_PM_I_DP9         : > RAML3,          PAGE = 1
...
/*
   .AX0_PM_I_DP5 { *(AX0_PM_I_DP5)
                } load = (RT_VAR_RAM_L3_05 PAGE 1 ALIGN(64))

   .AX0_PM_I_DP6 { *(AX0_PM_I_DP6)
                } load = (RT_VAR_RAM_L3_06 PAGE 1 ALIGN(64))

   .AX0_PM_I_DP8 { *(AX0_PM_I_DP8)
                } load = (RT_VAR_RAM_L3_08 PAGE 1 ALIGN(64))

   .AX0_PM_I_DP9 { *(AX0_PM_I_DP9)
                } load = (RT_VAR_RAM_L3_09 PAGE 1 ALIGN(64))
*/
